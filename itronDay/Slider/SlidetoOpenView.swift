...
@objcMembers public class SlideToOpenView: UIView {
    // MARK: All Views
    ...
    public let thumnailImageView: UIImageView = {
        ...
        view.layer.borderColor = UIColor(hexString: "#ffe972").cgColor
        return view
    }()
...
//        view.layer.borderColor = UIColor(hexString: "#7ac9f5").cgColor
    ...
    public var sliderBackgroundColor: UIColor = UIColor(red:0.1, green:0.61, blue:0.84, alpha:0.1) {
        didSet {
            ...
            sliderTextLabel.textColor = textColor//sliderBackgroundColor
        }
    }
    ...
    public var textFont: UIFont = UIFont(name: "ComicSansMS", size: 18.0)! {//UIFont.systemFont(ofSize: 20.0) {
        didSet {
    ...
    private func setupConstraint() {
        ...
        //thumnailImageView.widthAnchor.constraint(equalToConstant: 100.0).isActive = true
        //thumnailImageView.heightAnchor.constraint(equalToConstant: 20.0).isActive = true
    ...
    private func setStyle() {
        ...
        sliderTextLabel.text = labelText
        sliderTextLabel.font = textFont
        sliderTextLabel.lineBreakMode = .byWordWrapping
        sliderTextLabel.numberOfLines = 0
